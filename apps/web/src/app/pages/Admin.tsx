...
function providerModelDraftsFromControl(providers: AdminAiProviderSettingApiRecord[]) {
  const drafts: Record<string, string> = {};
...
function featureFlagDraftsFromControl(flags: AdminFeatureFlagApiRecord[]) {
...
function featureFlagDraftFromRecord(flag: AdminFeatureFlagApiRecord): FeatureFlagDraft {
  return {
    label: flag.label,
...
function promotionDraftsFromControl(promotions: AdminPromotionApiRecord[]) {
...
function promotionDraftFromRecord(promotion: AdminPromotionApiRecord): PromotionDraft {
  return {
...
function contentBlockDraftsFromControl(blocks: AdminContentBlockApiRecord[]) {
...
function contentBlockDraftFromRecord(block: AdminContentBlockApiRecord): ContentBlockDraft {
  return {
    title: block.title,
    body: block.body,
...
function contentBlockKey(block: Pick<AdminContentBlockApiRecord, "key" | "locale">) {
...
function adminHeader(tab: AdminTab) {
  switch (tab) {
    ...
    default:
      return {
        title: "Панель управления nomduchat",
        subtitle:
...
function agentCategoryLabel(value: string) {
  const labels: Record<string, string> = {
    business: "бизнес",
    code: "код",
    documents: "документы",
...
function createEmptyAdminControlState(): AdminControlStateApiResponse {
  return {
    featureFlags: [],
    aiProviders: [],
    agents: [],

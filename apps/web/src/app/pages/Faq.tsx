...
const faqGroups = [
  ...
  },
  {
    ...
    items: [
      {
        question: "Где создавать изображение, видео или озвучку?",
        answer: "Для каждого формата есть отдельная студия в разделе «Медиа» с подходящими параметрами и своей историей генераций.",
      },
      {
